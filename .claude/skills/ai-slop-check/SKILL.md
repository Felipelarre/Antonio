---
name: ai-slop-check
description: Use when reviewing or finishing HTML/CSS design work to detect and fix generic "AI-generated template" visual patterns — gradients, emoji decoration, default card styles, stock illustration, silent default fonts, harsh pure white/black, off-scale spacing, and the editorial-warm house style used without a brand reason.
---
